...
Fixtures live in `memorysafe_backend::conformance::fx`: `embedder()` (a `DeterministicEmbedder` at **dim 256**, embedder id `deterministic-256`), `item`, `item_with`, `vector_for`, `admit_txn`, `admit_txn_embedded`, `evict_txn`.
